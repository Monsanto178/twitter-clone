...
export const SideMenu = () => {
    return (
        <>
        <aside className="flex flex-col gap-y-4 text-[20px] px-0 md:px-2">
            <article className="flex flex-col">
                <a href="" className="flex w-fit md:w-auto gap-x-2 items-center transition-all duration-500 ease-in-out hover:bg-[#82828269] p-4 rounded-[25px]">
