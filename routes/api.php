...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/profile/getProfile', [ProfileController::class, 'getProfile'])->middleware('throttle:105,1');
    Route::post('/profile/getUsername', [ProfileController::class, 'getUsername'])->middleware('throttle:105,1');
    ...
    Route::post('/profile/follow', [ProfileController::class, 'follow'])->middleware('throttle:100,1');
    Route::put('/profile/update', [ProfileController::class, 'update'])->middleware('throttle:100,1');
